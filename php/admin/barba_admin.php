...
$servicio = 'barba';  // Para este archivo; cambiar en otros (ej: 'tintura')
...
try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM barba ORDER BY id ASC");  // Cambiar tabla por servicio si aplica (ej: barba para barba_admin.php)
    $stmt->execute();
        ...
        <div class="modal fade" id="editModal<?php echo $contenido['id']; ?>" tabindex="-1" aria-labelledby="editModal<?php echo $contenido['id']; ?>Label" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/php/guardar_barba.php" method="POST" enctype="multipart/form-data">
