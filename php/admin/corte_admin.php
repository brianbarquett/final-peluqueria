...
$servicio = 'corte';  // Para este archivo; cambiar en otros (ej: 'tintura')
...
try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM contenidos ORDER BY id ASC");  // Cambiar tabla por servicio si aplica (ej: barba para barba_admin.php)
    $stmt->execute();
