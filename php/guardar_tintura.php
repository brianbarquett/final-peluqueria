...
try {
    ...
    if ($id === 0) {
        ...
        $stmt = $pdo->prepare("INSERT INTO tintura (titulo, descripcion, precio, imagen) VALUES (:titulo, :descripcion, :precio, :imagen)");
        $stmt->execute([
            ':titulo' => $titulo,
        ...
        $sql = "UPDATE tintura SET titulo = :titulo, descripcion = :descripcion, precio = :precio";
    ...
    header("Location: admin/tintura_admin.php");  // Redirige a la versión admin después de guardar
    exit;
} catch (Exception $e) {
