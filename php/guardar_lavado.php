...
try {
    ...
    if ($id === 0) {
        ...
        $stmt = $pdo->prepare("INSERT INTO lavado (titulo, descripcion, precio, imagen) VALUES (:titulo, :descripcion, :precio, :imagen)");
        $stmt->execute([
            ':titulo' => $titulo,
        ...
        $sql = "UPDATE lavado SET titulo = :titulo, descripcion = :descripcion, precio = :precio";
    ...
    header("Location: admin/lavado_admin.php");  // Redirige a la versión admin después de guardar
    exit;
} catch (Exception $e) {
